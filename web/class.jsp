<%-- 
    Document   : class.jsp
    Created on : Jun 29, 2024, 5:22:25 PM
    Author     : ADMIN
--%>
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <!-- Student Count -->
            <p class="student-count">Số Lượng học sinh: ${requestScope.count}</p>

            <%  // Display either all students or search results
