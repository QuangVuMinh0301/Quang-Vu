<%-- 
    Document   : TuVe
    Created on : Jun 29, 2024, 5:34:23 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            <h1>Lớp Tự Vệ</h1>
             <p class="student-count">Số Lượng học sinh: ${requestScope.countTuVe}</p>
        ...
        %>
            <table>
               ...
               <%
                    ...
                    <td><a href="delete?id=<%= s.getClassChungID() %>&oldClass=LopTuVe">Delete</a></td>
                </tr>
                <%
                        }
                    }
