<%-- 
    Document   : HLV
    Created on : Jun 29, 2024, 5:34:30 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            <h1>Lớp Kèm 1-1 HLV</h1>
             <p class="student-count">Số Lượng học sinh: ${requestScope.countHLV}</p>
        ...
        %>
            <table>
               ...
               <%
                    ...
                    <td><a href="delete?id=<%= s.getClassChungID() %>&oldClass=LopHLV">Delete</a></td>
                </tr>
                <%
                        }
                    }
