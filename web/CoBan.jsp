<%-- 
    Document   : CoBan
    Created on : Jun 29, 2024, 5:33:47 PM
    Author     : ADMIN
--%>
   ...
   <style>
    ...
    <body>
        ...
        <div class="main-content">
            <h1>Lớp Cơ Bản</h1>
             <p class="student-count">Số Lượng học sinh: ${requestScope.countCoBan}</p>
        ...
        %>
            <table>
               ...
               <%
                    ...
                    <td><a href="delete?id=<%= s.getClassChungID() %>&oldClass=LopCoBan">Delete</a></td>
                </tr>
                <%
                        }
                    }
