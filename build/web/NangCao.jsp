<%-- 
    Document   : NangCao
    Created on : Jun 29, 2024, 5:33:55 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            <h1>Lớp Nâng Cao</h1>
             <p class="student-count">Số Lượng học sinh: ${requestScope.countNangCao}</p>
        ...
        %>
            <table>
               ...
               <%
                    ...
                    <td><a href="delete?id=<%= s.getClassChungID() %>&oldClass=LopNangCao">Delete</a></td>
                </tr>
                <%
                        }
                    }
